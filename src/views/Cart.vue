    ...
    methods: {
        ...
        updateCart(item, type) { 
            let quantity = item.quantity, //数量
                selected = item.productSelected;  //默认为false
            if (type == '-') {
                if (quantity == 1) {
                ...
                if(quantity > item.productStock) {//所选择的商品大于库存量
        ...
        order(){
            ...
            this.$message.warning('请选择一件商品');
                ...
                this.$router.push('/order/confirm');  //跳转到确定页面
            }
        }
    }
}
...
.cart {
    .wrapper {
        ...
        .cart-box {
            ...
            .cart-item-head {
                display: flex;
                //height 和 line-height 一样高让元素内容垂直居中
                height: 79px;
                line-height: 79px;
                .col-1 {
                    flex: 1;
